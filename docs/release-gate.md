...
| 2026-09-16 | Pre-publication security and privacy review; item A8 added. | This document, A8 |
| Pending | Owner decision on A8, then publication (visibility change or new repository), tag and GitHub release, repository description and topics, A7 re-run, C8-C10. | To be recorded here |
