...
Ticked: A1-A6, A8, B, C8, C9. Unticked: A7 (the repository's own URLs need a public
repository) and C10 (private vulnerability reporting and secret scanning need a public
repository). No box was ticked without evidence recorded next to it.
...
- **Current state:** A1-A6, A8, B, C8 and C9 are ticked, and CI enforces A3 and the
  offline checks on every pull request. A7 and C10 wait for the visibility change.
...
| Pending | Visibility change; private vulnerability reporting, secret scanning and fork pull-request approval; A7 re-run; C10; tag and GitHub release v1.1.0; archive of the private repository. | To be recorded here |
